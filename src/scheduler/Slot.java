...
public class Slot {
    ...
    public Slot(String slotId){
        this(Slot.NULL_HOUR, Slot.NULL_DAY, slotId, Room.NULL_NAME, Room.NULL_ID);
    }
    ...
    public Slot(int day, int hour){
        this(hour, day, Component.NULL_NAME, Room.NULL_NAME, Room.NULL_ID);
    }
    ...
    public Slot( int timeSlot, int day, String slotId, String roomId, int roomSize){
    ...
    final static int NULL_DAY = -1;
    /** Time constants */
    final static int HOUR_9_11 = 0;
    final static int HOUR_11_13 = 1;
    final static int HOUR_13_15 = 2;
    final static int HOUR_15_17 = 3;
    final static int HOUR_17_19 = 4;
    final static int HOUR_19_21 = 5;
    final static int NULL_HOUR = -2;
